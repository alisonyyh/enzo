    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-0">
      ...
      >
        ...
        <div className="flex flex-col px-5 pt-8">
          <h1 className="text-[24px] font-bold text-foreground mb-3">
          ...
          {/* Invite code input — prominent with primary border */}
          <div className="space-y-2">
            <input
              ...
              autoCorrect="off"
              spellCheck={false}
              className={`w-full h-14 px-5 rounded-[20px] text-base tracking-wide font-medium bg-card border-2 outline-none transition-colors placeholder:text-muted-foreground/50 ${
                error
          ...
          <Button
            ...
            disabled={!canSubmit}
            className="w-full h-[50px] mt-5 rounded-xl text-base font-medium"
          >
            {isSubmitting ? (
