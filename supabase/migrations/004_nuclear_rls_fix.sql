...
-- This ensures no stale/conflicting policies exist
...
-- Puppy memberships
DROP POLICY IF EXISTS "Users can read their own memberships" ON puppy_memberships;
...
DROP POLICY IF EXISTS "Invite participants can update invites" ON invites;
...
-- ============================================
-- STEP 4: Recreate ALL policies cleanly
-- ============================================
...
CREATE POLICY "invites_select_any" ON invites FOR SELECT
  TO authenticated
  USING (true);
...
-- ============================================
-- STEP 5: Verify - show all policies
-- ============================================
